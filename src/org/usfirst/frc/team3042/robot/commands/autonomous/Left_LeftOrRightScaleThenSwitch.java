 ...
 *
 */
public class Left_LeftOrRightScaleThenSwitch extends Command {
    ...
    public Left_LeftOrRightScaleThenSwitch() {
    ...
    protected void initialize() {
    	...
    	if (Robot.getScaleSide() == Robot.Side.LEFT) {
    		if (Robot.getSwitchSide() == Robot.Side.LEFT) {
    			new Left_LeftScaleLeftSwitch().start();
    		} else {		
    			new Left_LeftScale().start();
    		}
    	} else {
    		if (Robot.getSwitchSide() == Robot.Side.RIGHT) {
    			new Left_RightScaleRightSwitch().start();
    		} else {
